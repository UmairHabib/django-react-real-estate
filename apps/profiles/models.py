...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(
        verbose_name=_("Phone Number"), max_length=30, default="+923019876543"
    )
    about_me = models.TextField(
        verbose_name=_("About me"), default="Tell us something about yourself"
    )
    ...
    is_agent = models.BooleanField(
        verbose_name=_("Agent"), default=False, help_text=_("Are you agent?")
    )
