...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length=30, default="+923019876543")
    about_me = models.TextField(verbose_name=_("About me"), default="Tell us something about yourself")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Lahore", blank=False, null=False)
