# Factories allows alot of automation, its same like django models
# use lazy variables, valued assigned after other work and value is assigned each time because it is generated
...
class UserFactory(factory.django.DjangoModelFactory):
    ...
    email = factory.LazyAttribute(lambda x: f"umairhabib000@GMAIL.COM")
